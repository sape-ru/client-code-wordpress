...
Затем Вам необходимо загрузить в папку с сайтом файл вида d12d0d074c7ba7f6f78d60e2bb560e3f.php и произвести необходимые настройки в разделе «Статьи» - https://articles.sape.ru/wm/sites/
